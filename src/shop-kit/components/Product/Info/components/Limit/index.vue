<template>
<div class="sk-product_info-limit">
  <div class="s-bar">
    <s-bar :key="sku.id + marketing.info['2']['start_at']" :info="oNowEventInfo" :price="nEventPrice" @start="fnStart" @end="fnEnd"></s-bar>
  </div>
  <div class="s-cont" v-if="isStart">
    <div class="s-price">
      <div class="s-dt">折扣价</div>
      <div class="s-dd">
