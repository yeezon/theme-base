...
<div class="sk-product_info-presell-bar" v-if="info.start_at">
  <span class="s-h" v-if="isStarted">全款预售</span>
  <span class="s-tips" v-if="isStarted">预售剩余</span>
  ...
  <div class="s-fr" v-if="moreURL">
    <span class="s-kill">
      <a class="s-more" :href="moreURL" target="_blank"><span>更多预售</span><sk-icon name="right_circle"></sk-icon></a>
